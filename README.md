...
* 如果你喜欢我的这个博客模板，请在`tianyaxiang.github.io`这个repository点个赞——右上角**star**一下。
...
## 致谢
1. 这个模板原版是出自这里[IronSummitMedia/startbootstrap-clean-blog-jekyll](https://github.com/IronSummitMedia/startbootstrap-clean-blog-jekyll) 。 感谢这个作者
2. 当前这个模板是从  [huxpro.github.io](https://github.com/huxpro/huxpro.github.io)  fork 的。 感谢这个作者
